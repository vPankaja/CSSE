        ...
        <>
            ...
            <div className="bottomContent">
                <div className="p-5 mb-5">
                    ...
                    <input type="text" className="p-1 mb-3" onChange={e => {setFName(e.target.value)}} />

                    <div className="reloadLabel">
                        Last Name
                    </div>
                    <input type="text" className="p-1 mb-3" onChange={e => {setLName(e.target.value)}} />

                    <div className="reloadLabel">
                        Email
                    </div>
                    <input type="email" className="p-1 mb-3" onChange={e => {setEmail(e.target.value)}} />

                    <div className="reloadLabel">
                        Account Number
                    </div>
                    <input type="text" className="p-1 mb-3" onChange={e => {setAccNo(e.target.value)}} />

                    <div className="reloadLabel">
                        Amount
                    </div>
                    <input type="number" className="p-1 mb-3" onChange={e => {setAmount(e.target.value)}} />
                    <div className="reloadLabel">
                        Phone No
                    </div>
                    <input type="text" className="p-1 mb-3" onChange={e => {setPhone(e.target.value)}} />

                    <button className="nextBtn p-3" onClick={checkout}>Next</button>
                </div>
            </div>
            <Footer />
        </>
